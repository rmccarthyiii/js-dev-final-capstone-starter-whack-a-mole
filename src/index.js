...
// music and hit sounds
let bgMusic = document.getElementById("song");
...
function setDelay(difficulty) {
  if (difficulty === "easy") {
    ...
    return randomInteger(600, 1200); // "hard" = 600-1200ms randomized
  }
}
...
function startGame() {
  ...
  startButton.textContent = "Shoot the Molbots!";
  clearScore();
  setEventListeners();
